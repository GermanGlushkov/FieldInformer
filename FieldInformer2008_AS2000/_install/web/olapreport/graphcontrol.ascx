<%@ control language="c#" inherits="FI.UI.Web.OlapReport.GraphControl, App_Web_5ywhrcjl" enableviewstate="False" %>
			...
			<table height="0px" cellSpacing="0" cellPadding="1" border="1">
				<tr>
					...
					<td noWrap><font color="navy" size="-2"> &nbsp;<b>Image</b> 
							...
							&nbsp;&nbsp;Line Series Ordinal:
							<asp:TextBox Runat="server" ID="txtMixedLinePos" CssClass="tbl1_edit" Width="25px" MaxLength="2" EnableViewState="False" />
							</asp:PlaceHolder>
