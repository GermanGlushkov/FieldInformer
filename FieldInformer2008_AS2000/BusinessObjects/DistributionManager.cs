    ...
    public class DistributionManager
    {
        ...
        */
        ...
        public void SendReport(Report report, Contact[] contacts, Report.ExportFormat Format, DateTime getCachedFrom, out bool isFromCache)
        {
            ...
            string fileName = fileNamePattern + DateTime.Now.ToString("yyyyMMddHHmmssfff") + "." + Format.ToString();
            string cacheLookupFileName = fileNamePattern + getCachedFrom.ToString("yyyyMMddHHmmssfff") + "." + Format.ToString();
