...
<%@ Control Language="c#" Inherits="FI.UI.Web.ReportGridControl" enableViewState="False" CodeFile="ReportGridControl.ascx.cs" CodeFileBaseClass="FI.UI.Web.Controls.FIDataTableGrid" %>
