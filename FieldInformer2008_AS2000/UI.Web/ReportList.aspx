...
<%@ Reference Control="~/storecheckreport/reportloadcontrol.ascx" %>
<%@ Reference Control="~/mdxreport/reportloadcontrol.ascx" %>
<%@ Reference Control="~/sqlreport/reportloadcontrol.ascx" %>
<%@ Reference Control="~/olapreport/reportloadcontrol.ascx" %>
...
<%@ Reference Control="~/ReportListControl.ascx" %>
<%@ Reference Page="~/PageBase.aspx" %>
<%@ Page language="c#" Inherits="FI.UI.Web.ReportList" validateRequest="false" CodeFile="ReportList.aspx.cs" CodeFileBaseClass="FI.UI.Web.PageBase" %>
