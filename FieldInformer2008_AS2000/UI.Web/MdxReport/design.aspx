<%@ Reference Control="~/mdxreport/designcontrol.ascx" %>
<%@ Reference Control="~/mdxreport/importolapreportcontrol.ascx" %>
...
<%@ Page language="c#" Inherits="FI.UI.Web.MdxReport.Design" validateRequest="false" CodeFile="Design.aspx.cs" CodeFileBaseClass="FI.UI.Web.MdxReport.MdxPageBase" %>
