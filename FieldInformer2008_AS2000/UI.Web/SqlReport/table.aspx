...
<%@ Reference Control="~/sqlreport/reportpropertiescontrol.ascx" %>
<%@ Reference Control="~/sqlreport/executecontrol.ascx" %>
<%@ Reference Control="~/controls/tabs/tabview.ascx" %>
<%@ Reference Page="~/sqlreport/sqlpagebase.aspx" %>
...
<%@ Page language="c#" Inherits="FI.UI.Web.SqlReport.Table" aspCompat="False" enableViewState="False" CodeFile="Table.aspx.cs" CodeFileBaseClass="FI.UI.Web.SqlReport.SqlPageBase" %>
