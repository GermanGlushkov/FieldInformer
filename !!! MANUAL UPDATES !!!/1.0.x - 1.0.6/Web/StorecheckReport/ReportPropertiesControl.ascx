	...
	<tr>
		...
		<td noWrap>
			<font color="navy" size="-2">
				<asp:button id="btnUpdate" runat="server" Text="Save" CssClass="tbl1_ctrl" Runat="server" Height="22px"
					Width="75px" CommandName="Update"></asp:button>
			</font>
		</td>
	</tr>
	<tr>
		<td noWrap colspan="2">
			<font color="navy" size="-2">&nbsp;<b>Date To Count From(Today):</b> &nbsp;<asp:Label ID="lblToday" Runat="server" CssClass="tbl1_edit_box"></asp:Label>
				...
				&nbsp;&nbsp;&nbsp;&nbsp;<b>Product Join Logic:</b>&nbsp; 
				&nbsp;&nbsp;&nbsp;&nbsp;<asp:DropDownList ID="ddlLogic" Runat="server" CssClass="tbl1_edit_box"></asp:DropDownList></font>
		</td>
	</tr>
	<tr>
		<td noWrap width="100%">
			<font color="navy" size="-2">&nbsp;<b>Selection Option:</b>&nbsp;
				<asp:DropDownList ID="ddlSelection" Runat="server" CssClass="tbl1_edit_box"></asp:DropDownList></font>
		</td>
		<td noWrap>
			<font color="navy" size="-2">
				<asp:button id="btnUpdateDays" runat="server" Text="Update" CssClass="tbl1_ctrl" Runat="server"
