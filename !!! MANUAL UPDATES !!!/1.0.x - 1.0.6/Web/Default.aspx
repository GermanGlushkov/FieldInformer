...
<%@ Page language="c#" Codebehind="Default.aspx.cs" AutoEventWireup="false" Inherits="FI.UI.Web.Default" %>
							...
							<TR>
									...
									<table class="t_act" cellpadding="5" width="180">
										<tr>
											<td>
												...
												<asp:TextBox Runat="server" ID="txtCompany" MaxLength="15"></asp:TextBox>
											</td>
										</tr>
										<tr>
											<td>
												<asp:Label Runat="server" ID="lblLogin">User Login:</asp:Label>
												<asp:TextBox Runat="server" ID="txtLogin" MaxLength="50"></asp:TextBox>
											</td>
										</tr>
										<tr>
											<td>
												<asp:Label Runat="server" ID="lblPassword">Password:</asp:Label>
												<asp:TextBox TextMode="Password" Runat="server" ID="txtPassword" MaxLength="50"></asp:TextBox>
											</td>
										</tr>
										<tr>
											<td>
								...
								<TD class="bckgr1" valign="top" width="100%">
									<TABLE class="bckgr1" id="Table2" height="100%" cellSpacing="3" cellPadding="3" width="100%"
										border="0">
										<TR>
											<TD class="tbl1_capt" align="center" height="25"><asp:Label Runat="server" ID="lblVersion" ForeColor="navy" EnableViewState="False"></asp:Label>&nbsp;<asp:Label Runat="server" ID="lblHeader" ForeColor="red"></asp:Label></TD>
										</TR>
										<TR>
