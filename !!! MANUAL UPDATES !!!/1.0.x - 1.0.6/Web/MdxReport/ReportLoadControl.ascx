<%@ Control Language="c#" AutoEventWireup="false" Codebehind="ReportLoadControl.ascx.cs" Inherits="FI.UI.Web.MdxReport.ReportLoadControl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
