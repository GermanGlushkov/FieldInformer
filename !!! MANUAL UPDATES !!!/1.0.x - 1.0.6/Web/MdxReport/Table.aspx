<%@ Page language="c#" Codebehind="Table.aspx.cs" AutoEventWireup="false" Inherits="FI.UI.Web.MdxReport.Table" aspCompat="False" enableViewState="False" %>
											...
											<TD class="tbl1_capt" vAlign="middle" align="left" height=0>
												<table height="0px" cellSpacing="1" cellPadding="2" >
													<tr>
														...
														<td>	<uc1:ExecuteControl id="ExC" runat="server"></uc1:ExecuteControl>
														</td>
