...
<%@ Control Language="c#" AutoEventWireup="false" Codebehind="DesignControl.ascx.cs" Inherits="FI.UI.Web.MdxReport.DesignControl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
						...
						<table height="100%" cellSpacing="0" cellPadding="0" width="100%">
							<tr>
								<td TD class="tbl1_capt" vAlign="middle" align="left">
									&nbsp;Query:&nbsp;<asp:button id="btnUpdateMdx" CommandName="Update Mdx" Runat="server" Width="75px" Height="25px"
										CssClass="tbl1_ctrl" Text="Update Mdx"></asp:button>
									&nbsp;&nbsp;&nbsp;<asp:button id="btnIMportOlapReport" CommandName="Import" Runat="server" Width="125px" Height="25px"
										CssClass="tbl1_ctrl" Text="Import Olap Report"></asp:button>
								</td>
							</tr>
							<tr>
								<td valign="top">
