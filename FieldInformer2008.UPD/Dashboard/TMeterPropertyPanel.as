package
{
	...
	public class TMeterPropertyPanel extends ModalSprite
	{
		...
		function TMeterPropertyPanel(serviceUrl:String, userId:String, gaugeId:String)
		{						
		...
		/*
		function EnableEditControls(enable:Boolean)
		{
			for(var i=0; i<this.numChildren-1; i++)
			{
				var obj:UIComponent = this.getChildAt(i) as UIComponent;
				if(obj!=null)
					obj.visible=enable;
			}
		...
		*/
		...
		function onLoadConfig()		
		{
			...
			dynVal.initDynamic(_serviceUrl, _userId, "VAL", _xml..GAUGE[0]);
		...
		function saveConfig()
		{
			...
			reqData.GAUGE[0].appendChild(new XML(dynVal.getDynamicValueXml(true))); 
