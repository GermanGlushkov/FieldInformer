...
//			__dataAccessUrl="gtcp://127.0.0.1:8070/";
        ...
        public IDashboardSystemDA GetDashboardSystemDA()
        {
            return (IDashboardSystemDA)Activator.GetObject(typeof(IDashboardSystemDA), __dataAccessUrl + "IDashboardSystemDA");
        }
