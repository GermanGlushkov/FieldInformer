...
namespace FI.BusinessObjects.Olap
{
	...
	public abstract class CalculatedMember:DataMember
	{
        ...
        private MdxParameters _mdxParameters = null; // used to parse formula
		...
		{
            _mdxParameters = new MdxParameters(hier);
        ...
        public MdxParameters MdxParameters
        {
    ...
    public class MdxParameters : Objects
    {
        private Hierarchy _hier;
        Objects _checkHier = new Objects();

        internal MdxParameters(Hierarchy hier)
		{
			if(hier==null)
        ...
        //public void Add(Dimension param, bool checkHierarchyMatch)
        //{
        //    Add(param, checkHierarchyMatch, false);
        //}

        public void Add(Dimension param, bool checkHierarchyMatch, bool replaceExisting)
		{
            if (checkHierarchyMatch && this.Hierarchy.Dimension.UniqueName != param.UniqueName)
            {
                _checkHier.Add(param, true);
                throw new Exception("Hierarchy mismatch");
            }
            base.Add(param, replaceExisting);
		}
        ...
        public void Add(Hierarchy param, bool checkHierarchyMatch, bool replaceExisting)
        {
            if (checkHierarchyMatch && this.Hierarchy.UniqueName != param.UniqueName)
            {
                _checkHier.Add(param, true);
                throw new Exception("Hierarchy mismatch");
            }
        ...
        public void Add(Level param, bool checkHierarchyMatch)
        {
            Add(param, checkHierarchyMatch, false);
        }

        public void Add(Level param, bool checkHierarchyMatch, bool replaceExisting)
        {
            if (checkHierarchyMatch && this.Hierarchy.UniqueName != param.Hierarchy.UniqueName)
            {
                _checkHier.Add(param, true);
                throw new Exception("Hierarchy mismatch");
            }
        ...
        public void Add(Member param, bool checkHierarchyMatch)
        {
            Add(param, checkHierarchyMatch, false);
        }

        public void Add(Member param, bool checkHierarchyMatch, bool replaceExisting)
        {
            if (checkHierarchyMatch && this.Hierarchy.UniqueName != param.Hierarchy.UniqueName)
            {
                _checkHier.Add(param, true);
        ...
        public bool CheckHierarchy(string uniqueName)
        {
            return _checkHier[uniqueName] != null;
        }
