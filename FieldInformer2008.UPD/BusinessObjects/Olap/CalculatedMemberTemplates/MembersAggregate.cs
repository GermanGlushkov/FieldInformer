...
namespace FI.BusinessObjects.Olap.CalculatedMemberTemplates
{
	public class MembersAggregate:CalculatedMember
	{
		...
		{
            this.MdxParameters.Add(mem, true, true);
		}

		public void RemoveMember(string UniqueName)
		{
            this.MdxParameters.Remove(UniqueName);
		}

		public MdxParameters Members
		{
			get{return this.MdxParameters;}
		}

		public void ClearMembers()
		{
			this.MdxParameters.Clear();
		}

		internal void Initialize(string name)
		{
			this.MdxParameters.SetCollectionType(typeof(Member), true);
		...
		public override string MDXDefinitions
		{
			get
			{
				...
				sb.Append("({");
				foreach(Object obj in this.MdxParameters)
				{
