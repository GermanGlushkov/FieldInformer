...
<%@ page language="c#" inherits="FI.UI.Web.WebServices.DistributionManager, App_Web_distributionmanager.aspx.f0e9dea3" enableviewstate="False" %>
							...
							<TR>
								<TD class="tbl1_capt" id="cellControls" runat="server">&nbsp;
									...
									<asp:button id="btnSend" CssClass="tbl1_ctrl" Height="25px" Width="120px" Text="Send Enqueued"
										...
										<asp:button id="btnForceSend" CssClass="tbl1_ctrl" Height="25px" Width="120px" Text="Force Send Enqueued"
										Runat="server" CommandName="Send" onclick="btnForceSend_Click"></asp:button>&nbsp;
