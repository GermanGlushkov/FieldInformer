...
<%@ control language="c#" inherits="FI.UI.Web.ReportDistributionControl, App_Web_reportdistributioncontrol.ascx.cdcab7d2" %>
	...
	<TR>
		<TD>
			<TABLE class="bckgr1" id="Table2" height="100%" cellSpacing="3" cellPadding="3" width="100%"
				...
				<TR>
					<TD>
						<TABLE id="Table2" height="100%" cellSpacing="0" cellPadding="1" width="100%" border="0">
							<TR>
								<TD class="bckgr1">
				...
				<TR>
					<TD class="tbl1_capt" height="1"></TD>
				</TR>
				<TR>
					<TD class="bckgr1">&nbsp;&nbsp;Format:&nbsp;&nbsp;<asp:DropDownList ID="ddlFormat" runat="server" Height="25px" Width="75px"></asp:DropDownList></TD>
				</TR>
				<TR>
					<TD class="tbl1_capt" vAlign="middle" align="left" height="0px">
						...
						<asp:button id="ViewLogButton" Text="View Log" CssClass="tbl1_ctrl" Height="25px" Width="75px"
							Runat="server" CommandName="Cancel" onclick="ViewLogButton_Click"></asp:button>
						<asp:button id="EnqueueNowButton" CommandName="Enqueue Now" Runat="server" Text="Enqueue Now"
							Width="90px" Height="25px" CssClass="tbl1_ctrl" onclick="EnqueueNowButton_Click"></asp:button>
						<asp:button id="SendNowButton" CommandName="Send Now" Runat="server" Text="Send Now (To Selected Contacts)"
							Width="220px" Height="25px" CssClass="tbl1_ctrl" onclick="SendNowButton_Click"></asp:button>
