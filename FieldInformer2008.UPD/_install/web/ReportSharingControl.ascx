...
<%@ control language="c#" inherits="FI.UI.Web.ReportSharingControl, App_Web_reportsharingcontrol.ascx.cdcab7d2" %>
				...
				<TR>
					<TD class="tbl1_capt" vAlign="middle" align="left" height="0px">
						...
						<asp:button id="btnDeleteAll" CommandName="DeleteSharing" Runat="server" Text="Delete All Shares"
							Width="125px" Height="25px" CssClass="tbl1_ctrl" onclick="btnDeleteAll_Click"></asp:button>
