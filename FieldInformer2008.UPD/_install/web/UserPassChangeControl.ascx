...
<%@ control language="c#" inherits="FI.UI.Web.UserPassChangeControl, App_Web_userpasschangecontrol.ascx.cdcab7d2" %>
	...
	<TR>
		<TD class="tbl1_capt" vAlign="middle" align="left" height="0px">
			<asp:button id="btnUpdate" CommandName="Update" Runat="server" Text="Update" Width="75px" Height="25px"
				CssClass="tbl1_ctrl" OnClick="btnUpdate_Click"></asp:button>
		</TD>
	</TR>
	<TR>
