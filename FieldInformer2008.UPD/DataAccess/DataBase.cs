...
namespace FI.DataAccess
{
	...
	public sealed class DataBase
	{
        ...
        {
            return ExecuteScalar(sql, FI.Common.AppConfig.DA_ConnectionString, parameters);
        }

		public object ExecuteScalar(string sql, string connectionString, SqlParameter[] parameters)
		{
