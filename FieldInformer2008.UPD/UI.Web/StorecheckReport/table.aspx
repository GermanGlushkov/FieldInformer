...
<%@ Page language="c#" Inherits="FI.UI.Web.StorecheckReport.Table" validateRequest="false" CodeFile="Table.aspx.cs" CodeFileBaseClass="FI.UI.Web.StorecheckReport.StorecheckPageBase" %>
												...
												<table height="0px" cellSpacing="1" cellPadding="2">
													<tr>
														<TD><asp:button id="btnClose" CssClass="tbl1_ctrl" Height="22px" Width="75px" Text="Close" Runat="server"
																CommandName="Close" onclick="btnClose_Click"></asp:button>&nbsp;
														</TD>
														<TD>
