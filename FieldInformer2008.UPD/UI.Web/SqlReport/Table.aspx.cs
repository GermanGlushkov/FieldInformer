...
namespace FI.UI.Web.SqlReport
{
	...
	public partial class Table : SqlPageBase
	{
		...
		private void LoadTabs()
		{
			...
			_tabView.AddTab(id1 , "  Table  " , Request.ApplicationPath + "/SqlReport/Table.aspx" , true , false);
			_tabView.AddTab(id1 , "  Design  " , Request.ApplicationPath + "/SqlReport/Design.aspx" , false , false);
		}
