...
<%@ Reference Control="~/olapreport/selectcontrol.ascx" %>
...
<%@ Page language="c#" Inherits="FI.UI.Web.OlapReport.Design" CodeFile="Design.aspx.cs" CodeFileBaseClass="FI.UI.Web.OlapReport.OlapPageBase" %>
										...
										<TR>
											<TD class="tbl1_capt" vAlign="middle" align="left">
												<table height="0px" cellSpacing="1" cellPadding="2">
													<tr>
														<TD>
															<asp:button id="btnSave" CssClass="tbl1_ctrl" Height="22px" Width="75px" Text="Save" Runat="server"
																CommandName="Save" onclick="btnSave_Click"></asp:button>
