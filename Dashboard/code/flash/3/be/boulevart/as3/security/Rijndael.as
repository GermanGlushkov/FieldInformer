package be.boulevart.as3.security { 
	...
	*/
	...
	public class Rijndael {
		...
		*/
		public function encryptStrToHex(src:String, key:String, mode:String):String {
		...
		* Encrypts a string with the specified key and mode.
		*/
		public function encryptHexToHex(src:String, key:String, mode:String):String {
			var ct:Array = new Array();
			var aBlock:Array = new Array();
			var bpb:Number = this.blockSize / 8;
			if (mode == "CBC") ct = this.getRandomBytes(bpb);
		...
		* Encrypts a string with the specified key and mode.
		*/
		public function encryptArrayToHex(chars:Array, key:String, mode:String):String {
			var ct:Array = new Array();
			var aBlock:Array = new Array();
			var bpb:Number = this.blockSize / 8;
			if (mode == "CBC") ct = this.getRandomBytes(bpb);
		...
		*/
		public function decryptHexToStr(src:String, key:String, mode:String):String {
		...
		* Decrypts a string with the specified key and mode.
		*/
		public function decryptHexToArray(src:String, key:String, mode:String):Array {
			var pt:Array = new Array();
			var aBlock:Array = new Array();
			var chars:Array = hexToChars(src);
			var bpb:Number = this.blockSize / 8;
