...
<%@ control language="c#" inherits="FI.UI.Web.OlapReport.ReportPropertiesControl, App_Web_reportpropertiescontrol.ascx.cf0b5421" enableviewstate="False" %>
<table class="tbl1_T" cellSpacing="0" cellPadding="0" border="0">
	<tr>
		...
		<td class="tbl1_C1"><asp:button id="btnProperties" runat="server" CssClass="sel_open" Runat="server" Height="13px"
				Width="13px" CommandName="Properties" onclick="btnProperties_Click"></asp:button></td>
	</tr>
	<tr id="emptyTuplesCell" runat="server">
		...
		<td class="tbl1_C1"><asp:button id="btnRowsUpdate" runat="server" CssClass="tbl1_ctrl" Runat="server" Height="22px"
				Width="75px" CommandName="UpdateEmptyCells" Text="Update" onclick="btnEmptyCellsUpdate_Click"></asp:button></td>
	</tr>
	<tr id="timeRangeCell" runat="server">
		...
		<td class="tbl1_C1"><asp:button id="btnAddTimeRange" runat="server" CssClass="tbl1_ctrl" Runat="server" Height="22px"
				Width="75px" CommandName="Add" Text="Add" onclick="btnAddTimeRange_Click"></asp:button></td>
	</tr>
	<tr id="filteredSetCell" runat="server">
		<td class="tbl1_H" noWrap><font size="-2">&nbsp;Add Filtered Set: &nbsp;</font>
		</td>
		<td class="tbl1_C1" noWrap><font size="-2">
				&nbsp;&nbsp;Level:
				<select class="tbl1_edit" id="selFilteredSetLevel" name="selFilteredSetLevel" runat="server">
				</select>
				&nbsp;&nbsp;Measure:
				<select class="tbl1_edit" id="selFilteredSetMeasure" style="WIDTH: 250px" name="selFilteredSetMeasure"
					runat="server">
				</select>
				&nbsp;&nbsp;Operator:
				<select class="tbl1_edit" id="selFilteredSetOperator" name="selFilteredSetOperator" runat="server">
				</select>
				&nbsp;&nbsp;Value:
				<input class="tbl1_edit" id="txtFilteredSetValue" type="text" maxLength="50" size="15" name="txtFilteredSetValue"
					runat="server">
				</font>
		</td>
		<td class="tbl1_C1"><asp:button id="btnAddFilteredSet" runat="server" CssClass="tbl1_ctrl" Runat="server" Height="22px"
				Width="75px" CommandName="Add" Text="Add" onclick="btnAddFilteredSet_Click"></asp:button></td>
	</tr>
	<tr id="calcRatioCell" runat="server">
		...
		<td class="tbl1_C1"><asp:button id="btnAddRatio" runat="server" CssClass="tbl1_ctrl" Runat="server" Height="22px"
				Width="75px" CommandName="Add" Text="Add" onclick="btnAddRatio_Click"></asp:button></td>
	</tr>
	<tr id="calcMeaCell" runat="server">
		...
		<td class="tbl1_C1"><asp:button id="btnAddCalc" runat="server" CssClass="tbl1_ctrl" Runat="server" Height="22px"
				Width="75px" CommandName="Add" Text="Add" onclick="btnAddCalc_Click"></asp:button></td>
	</tr>
</table>
