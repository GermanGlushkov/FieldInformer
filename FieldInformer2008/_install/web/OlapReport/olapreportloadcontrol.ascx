<%@ Reference Control="~/olapreport/calculatedmembercontrols/filteredbynamesetcontrol.ascx" %>
<%@ Reference Control="~/controls/fidatatablegrid.ascx" %>
<%@ control language="c#" inherits="FI.UI.Web.OlapReport.OlapReportLoadControl, App_Web_olapreportloadcontrol.ascx.cf0b5421" %>
