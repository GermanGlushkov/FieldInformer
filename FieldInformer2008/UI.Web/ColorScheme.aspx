...
<%@ Page language="c#" Inherits="FI.UI.Web.ColorScheme" CodeFile="ColorScheme.aspx.cs" CodeFileBaseClass="FI.UI.Web.PageBase" %>
										...
										<TR>
											<TD height="100%">
												<TABLE class="bckgr1" id="Table3" height="100%" cellSpacing="5" cellPadding="5" border="0">
													...
													<TR>
														<TD vAlign="top" noWrap align="left"><asp:radiobutton id="radioStyle4" Runat="server" GroupName="styles" EnableViewState="True"></asp:radiobutton></TD>
														<TD><IMG src="images/Style4_screenshot.jpg"></TD>
													</TR>
													<TR>
														<TD vAlign="top" noWrap align="left"><asp:radiobutton id="radioStyle5" Runat="server" GroupName="styles" EnableViewState="True"></asp:radiobutton></TD>
														<TD><IMG src="images/Style5_screenshot.jpg"></TD>
													</TR>
													<tr height="100%">
														<td height="100%">&nbsp;</td>
													</tr>
