...
namespace FI.UI.Web.SqlReport
{
	...
	/// </summary>
	public partial class Design : SqlPageBase
	{
		...
		private void LoadTabs()
		{
			...
			id=this.CreateRootTabs(_tabView , _user.Name , _user.IsLoggedIn , true , PageBase.RootTabsEnum.Custom_SQL_Reports);
			...
			_tabView.AddTab(id1 , "  Table  " , Request.ApplicationPath + "/SqlReport/Table.aspx", false , false);
			_tabView.AddTab(id1 , "  Design  " , Request.ApplicationPath  + "/SqlReport/Design.aspx" , true , false);
		}
		...
		private void LoadContents()
		{
			...
			// at the time only one control needed
			FI.UI.Web.SqlReport.DesignControl control = (FI.UI.Web.SqlReport.DesignControl)Page.LoadControl("DesignControl.ascx");
