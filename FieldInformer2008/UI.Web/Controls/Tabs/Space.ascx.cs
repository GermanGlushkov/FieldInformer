	...
	public partial  class Space : System.Web.UI.UserControl
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			if (IsRoot==true)
			{
                ...
                //    Table.Rows[0].Cells[0].HorizontalAlign = HorizontalAlign.Right;
                //    Table.Rows[0].Cells[0].VerticalAlign = VerticalAlign.Middle;
                //    Table.Rows[0].Cells[0].Controls.Add(capt);
                //    Table.Rows[0].Cells[1].Controls.Add(anch);
                //    Table.Rows[0].Cells[1].VerticalAlign = VerticalAlign.Middle;
                //}
                ...
                if (IsRoot)
                {
                    ...
                    string logoUrl = "~/images/logo.gif";
                    if (File.Exists(this.Server.MapPath(logoUrl)))
                    {
                        // logo
                        System.Web.UI.HtmlControls.HtmlImage img = new System.Web.UI.HtmlControls.HtmlImage();
                        img.Alt = FI.Common.AppConfig.AppName;
                        img.Src = logoUrl;
                        img.Border = 0;
                        Table.Rows[0].Cells[1].Controls.Add(img);
                    }
                    else
                    {
                        // appname
                        System.Web.UI.WebControls.Literal capt = new System.Web.UI.WebControls.Literal();
                        capt.Text = FI.Common.AppConfig.AppName;
                        Table.Rows[0].Cells[1].Controls.Add(capt);
                    }
                }
