...
IMPLEMENT_DYNAMIC(CTestXMLDlg, CDialog);
...
void CTestXMLDlg::OnCancel() 
{
	if (CanExit())
		CDialog::OnCancel();
}

BOOL CTestXMLDlg::CanExit()
{
...
#import "C:\Inetpub\wwwroot\FieldInformer.NET\COM\XMLCellsetWrapper\Debug\XMLCellsetWrapper.dll"
using namespace XMLCELLSETWRAPPERLib;

void CTestXMLDlg::OnButton1() 
{
	XMLCELLSETWRAPPERLib::IXMLCellsetPtr cst;
	HRESULT hr = cst.CreateInstance("XMLCellsetWrapper.XMLCellset");

	//hr=cst->BuildCellset2();
