<%@ Control Language="c#" AutoEventWireup="false" Codebehind="SelectControl.ascx.cs" Inherits="FI.UI.Web.OlapReport.SelectControl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" enableViewState="False"%>
