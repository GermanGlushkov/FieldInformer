...
namespace FI.UI.Web.OlapReport
{
	...
	public class Graph : OlapPageBase
	{
		...
		private void ExecuteCommands()
		{
			...
			try
			{
				for(int i=0;i<Request.Form.Count;i++)
				{
					...
					{						
						_contr.SetGraph(_graphControl.GraphType , _graphControl.GraphTheme, _graphControl.GraphWidth, _graphControl.GraphHeight,
							_graphControl.ShowValues, _graphControl.ShowSeries, _graphControl.ShowCat , _graphControl.SetScal, _graphControl.SetRotateAxes);
						break;
					}
