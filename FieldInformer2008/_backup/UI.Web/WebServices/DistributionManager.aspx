<%@ Page language="c#" Codebehind="DistributionManager.aspx.cs" AutoEventWireup="false" Inherits="FI.UI.Web.WebServices.DistributionManager" EnableViewState=False %>
							...
							<TR>
								<TD class="tbl1_capt" id="cellControls" runat="server">&nbsp;
									...
									<asp:button id="btnDetails" CssClass="tbl1_ctrl" Height="25px" Width="120px" Text="Show Log Details"
										Runat="server" CommandName="Details"></asp:button>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									...
									<asp:button id="btnDeleteDistr" CssClass="tbl1_ctrl" Height="25px" Width="120px" Text="Delete Distribution"
										Runat="server" CommandName="DeleteDistr" ForeColor="Red"></asp:button>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
