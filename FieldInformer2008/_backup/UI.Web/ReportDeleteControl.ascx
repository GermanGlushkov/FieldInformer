<%@ Control Language="c#" AutoEventWireup="false" Codebehind="ReportDeleteControl.ascx.cs" Inherits="FI.UI.Web.ReportDeleteControl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
