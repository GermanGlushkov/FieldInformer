<%@ Control Language="c#" AutoEventWireup="false" Codebehind="AddProductsControl.ascx.cs" Inherits="FI.UI.Web.StorecheckReport.AddProductsControl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
							...
							<tr>
								<TD class="tbl1_capt" vAlign="middle" align="left" height="25" nowrap>
									...
									<asp:button id="btnBack" runat="server" Text="Back" CssClass="tbl1_ctrl" Runat="server" Height="22px"
										Width="75px" CommandName="Back"></asp:button>
