namespace FI.UI.Web.SqlReport
{
	...
	public class ReportLoadControl : System.Web.UI.UserControl
	{
		...
		{
			_report=(FI.BusinessObjects.CustomSqlReport)_user.ReportSystem.GetReport(Id , typeof(FI.BusinessObjects.CustomSqlReport) , true);
		...
		private void RedirectToReport()
		{
			...
			if(_action=="Open" && FI.Common.AppConfig.ReportRunOnClick)
				Response.Redirect(Request.ApplicationPath + "/SqlReport/Table.aspx" , true);
			else
				Response.Redirect(Request.ApplicationPath + "/SqlReport/Design.aspx" , true);
		}
