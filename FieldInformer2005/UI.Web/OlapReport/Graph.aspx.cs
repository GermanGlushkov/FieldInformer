		...
		private void ExecuteCommands()
		{
			...
			try
			{
				for(int i=0;i<Request.Form.Count;i++)
				{
					...
					{
						_contr.SetGraph(_graphControl.GraphType , _graphControl.ShowCat , _graphControl.ShowSer , _graphControl.ShowVal , _graphControl.SetScal);
						break;
					}
