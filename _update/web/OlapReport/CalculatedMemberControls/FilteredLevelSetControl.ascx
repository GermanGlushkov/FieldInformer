<%@ Control Language="c#" AutoEventWireup="false" Codebehind="FilteredLevelSetControl.ascx.cs" Inherits="FI.UI.Web.OlapReport.CalculatedMemberControls.FilteredLevelSetControl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
<table class="bckgr1">
	<tr>
