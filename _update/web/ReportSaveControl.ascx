<%@ Control Language="c#" AutoEventWireup="false" Codebehind="ReportSaveControl.ascx.cs" Inherits="FI.UI.Web.ReportSaveControl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
			...
			<TABLE class="bckgr1" id="Table2" height="100%" cellSpacing="3" cellPadding="3" width="100%"
				...
				<TR>
					<TD class="tbl1_capt" vAlign="middle" align="left" height="0px"><asp:button id="OkButton" Text="Ok" CssClass="tbl1_ctrl" Height="25px" Width="75px" Runat="server"
							CommandName="Ok"></asp:button><asp:button id="BackButton" Text="Back" CssClass="tbl1_ctrl" Height="25px" Width="75px" Runat="server"
							CommandName="Back"></asp:button></TD>
				</TR>
				<TR>
