...
{
	public class ServiceSettingsForm : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			// txtPass
			// 
			this.txtPass.Location = new System.Drawing.Point(112, 48);
		...
		private void btnIniFileDialog_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				VersionBase.LatestVersion.LoadConfigService();
			}
			catch(Exception exc)
			{
		...
		private void btnOk_Click(object sender, System.EventArgs e)
		{
			try
			{
				VersionBase.LatestVersion.SqlSaPassword=this.txtPass.Text;
				VersionBase.LatestVersion.InstallService();
			}
			catch(Exception exc)
			{
