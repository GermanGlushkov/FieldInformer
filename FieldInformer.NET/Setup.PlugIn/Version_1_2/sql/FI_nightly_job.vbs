...
'strSaPass=""
'strSppPass="spp"
'strSppIniPath="c:\salespp\salespp.ini"
...
Set oCustomTask1 = oTask.CustomTask
	...
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	n=n+1 " & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	" & vbCrLf	
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strMember(n)=""POS Unit Sum"" " & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strDescription(n)=strMember(n) " & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strLevel1(n)=""Movement"" " & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strLevel2(n)="""" " & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strStatement(n)=""ValidMeasure([Measures].[PosUnitSum])"" " & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strFormat(n)=""### ### ### ### ##0.00""	 " & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strSolveOrder(n)=""0"" " & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	n=n+1 " & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strMember(n)=""POS Case Sum"" " & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strDescription(n)=strMember(n) " & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strLevel1(n)=""Movement"" " & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strLevel2(n)="""" " & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strStatement(n)=""ValidMeasure([Measures].[PosCaseSum])"" " & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strFormat(n)=""### ### ### ### ##0.00""	 " & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strSolveOrder(n)=""0"" " & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	n=n+1 " & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	" & vbCrLf	
...
oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "'------------------------------------ TIME MEMBERS -------------------------------------" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "If True=True Then" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	vbFirstDayOfWeek=2 ' " & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	vbFirstWeekOfYear=2 ' first four days" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	" & vbCrLf
	...
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strWeek=DatePart(""ww"", strNow , vbFirstDayOfWeek, vbFirstWeekOfYear)" & vbCrLf
	...
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	str_PrevWeek_Week=DATEPART(""ww"" , str_PrevWeek_Now , vbFirstDayOfWeek, vbFirstWeekOfYear)" & vbCrLf
	...
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	str_PrevWeekPrevYear_Week=DATEPART(""ww"" , str_PrevWeekPrevYear_Now , vbFirstDayOfWeek, vbFirstWeekOfYear)" & vbCrLf
	...
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	str_PrevYear_Week=DATEPART(""ww"" , str_PrevYear_Now , vbFirstDayOfWeek, vbFirstWeekOfYear)" & vbCrLf
	...
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strMember(n)=""Monthly Year-To-DateSA""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strParentDimension(n)=""[Time].[Monthly].[All Time Monthly]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strStatement(n)=""[Time].[Monthly].[Date].&["" & strDay & ""]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strSolveOrder(n)=""10""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strVisible(n)=0" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strFormat(n)=""### ### ### ##0.00""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	n=n+1" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strMember(n)=""Monthly Year-To-DateA""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strParentDimension(n)=""[Time].[Monthly].[All Time Monthly]""" & vbCrLf
	...
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strParentDimension(n)=""[Time].[Monthly].[All Time Monthly]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strStatement(n)=""IIF(Instr(MemberToStr([Measures].CurrentMember),""""Semiadd"""")>0, [Time].[Monthly].[Monthly Year-To-DateSA], [Time].[Monthly].[Monthly Year-To-DateA])""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strSolveOrder(n)=""10""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strFormat(n)=""### ### ### ##0.00""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	n=n+1" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strMember(n)=""Monthly Year-To-DatePrevYearSA""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strParentDimension(n)=""[Time].[Monthly].[All Time Monthly]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strStatement(n)=""[Time].[Monthly].[Date].&["" & str_PrevYear_Day & ""]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strSolveOrder(n)=""10""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strVisible(n)=0" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strFormat(n)=""### ### ### ##0.00""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	n=n+1" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strMember(n)=""Monthly Year-To-DatePrevYearA""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strParentDimension(n)=""[Time].[Monthly].[All Time Monthly]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strStatement(n)=""Aggregate( Except({ "" & _" & vbCrLf
	...
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strParentDimension(n)=""[Time].[Monthly].[All Time Monthly]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strStatement(n)=""IIF(Instr(MemberToStr([Measures].CurrentMember),""""Semiadd"""")>0, [Time].[Monthly].[Monthly Year-To-DatePrevYearSA], [Time].[Monthly].[Monthly Year-To-DatePrevYearA])""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strSolveOrder(n)=""10""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strFormat(n)=""### ### ### ##0.00""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	n=n+1		" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	" & vbCrLf
	...
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strMember(n)=""Monthly Year-To-PrevMonthSA""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strParentDimension(n)=""[Time].[Monthly].[All Time Monthly]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strStatement(n)=""[Time].[Monthly].[Month].&["" & str_PrevMonth_Month & ""]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strSolveOrder(n)=""10""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strVisible(n)=0" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strFormat(n)=""### ### ### ##0.00""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	n=n+1" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strMember(n)=""Monthly Year-To-PrevMonthA""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strParentDimension(n)=""[Time].[Monthly].[All Time Monthly]""" & vbCrLf
	...
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strParentDimension(n)=""[Time].[Monthly].[All Time Monthly]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strStatement(n)=""IIF(Instr(MemberToStr([Measures].CurrentMember),""""Semiadd"""")>0, [Time].[Monthly].[Monthly Year-To-PrevMonthSA], [Time].[Monthly].[Monthly Year-To-PrevMonthA])""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strSolveOrder(n)=""10""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strFormat(n)=""### ### ### ##0.00""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	n=n+1		" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	" & vbCrLf
	...
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strMember(n)=""Monthly Year-To-PrevMonthPrevYearSA""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strParentDimension(n)=""[Time].[Monthly].[All Time Monthly]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strStatement(n)=""[Time].[Monthly].[Month].&["" & str_PrevMonthPrevYear_Month & ""]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strSolveOrder(n)=""10""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strVisible(n)=0" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strFormat(n)=""### ### ### ##0.00""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	n=n+1" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strMember(n)=""Monthly Year-To-PrevMonthPrevYearA""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strParentDimension(n)=""[Time].[Monthly].[All Time Monthly]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strStatement(n)="" Aggregate(  "" & _" & vbCrLf
	...
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strParentDimension(n)=""[Time].[Monthly].[All Time Monthly]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strStatement(n)=""IIF(Instr(MemberToStr([Measures].CurrentMember),""""Semiadd"""")>0, [Time].[Monthly].[Monthly Year-To-PrevMonthPrevYearSA], [Time].[Monthly].[Monthly Year-To-PrevMonthPrevYearA])""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strSolveOrder(n)=""10""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strFormat(n)=""### ### ### ##0.00""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	n=n+1		" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	" & vbCrLf
	...
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	n=n+1" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strMember(n)=""Monthly PrevMonthSA""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strParentDimension(n)=""[Time].[Monthly].[All Time Monthly]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strStatement(n)=""[Time].[Monthly].[Month].&["" & str_PrevMonth_Month & ""]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strSolveOrder(n)=""10""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strVisible(n)=0" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strFormat(n)=""### ### ### ##0.00""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	n=n+1" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strMember(n)=""Monthly PrevMonthA""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strParentDimension(n)=""[Time].[Monthly].[All Time Monthly]""" & vbCrLf
	...
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strParentDimension(n)=""[Time].[Monthly].[All Time Monthly]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strStatement(n)=""IIF(Instr(MemberToStr([Measures].CurrentMember),""""Semiadd"""")>0, [Time].[Monthly].[Monthly PrevMonthSA], [Time].[Monthly].[Monthly PrevMonthA])""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strSolveOrder(n)=""10""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strFormat(n)=""### ### ### ##0.00""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	n=n+1		" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strMember(n)=""Monthly PrevMonthPrevYearSA""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strParentDimension(n)=""[Time].[Monthly].[All Time Monthly]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strStatement(n)=""[Time].[Monthly].[Month].&["" & str_PrevMonthPrevYear_Month & ""]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strSolveOrder(n)=""10""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strVisible(n)=0" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strFormat(n)=""### ### ### ##0.00""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	n=n+1" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strMember(n)=""Monthly PrevMonthPrevYearA""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strParentDimension(n)=""[Time].[Monthly].[All Time Monthly]""" & vbCrLf
	...
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strParentDimension(n)=""[Time].[Monthly].[All Time Monthly]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strStatement(n)=""IIF(Instr(MemberToStr([Measures].CurrentMember),""""Semiadd"""")>0, [Time].[Monthly].[Monthly PrevMonthPrevYearSA], [Time].[Monthly].[Monthly PrevMonthPrevYearA])""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strSolveOrder(n)=""10""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strFormat(n)=""### ### ### ##0.00""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	n=n+1		" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	" & vbCrLf
	...
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strMember(n)=""Weekly Year-To-DateSA""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strParentDimension(n)=""[Time].[Weekly].[All Time Weekly]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strStatement(n)=""[Time].[Weekly].[Date].&["" & strDay & ""]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strSolveOrder(n)=""10""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strVisible(n)=0" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strFormat(n)=""### ### ### ##0.00""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	n=n+1" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strMember(n)=""Weekly Year-To-DateA""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strParentDimension(n)=""[Time].[Weekly].[All Time Weekly]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strStatement(n)="" Aggregate( Except({ "" & _" & vbCrLf
	...
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strParentDimension(n)=""[Time].[Weekly].[All Time Weekly]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strStatement(n)=""IIF(Instr(MemberToStr([Measures].CurrentMember),""""Semiadd"""")>0, [Time].[Weekly].[Weekly Year-To-DateSA], [Time].[Weekly].[Weekly Year-To-DateA])""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strSolveOrder(n)=""10""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strFormat(n)=""### ### ### ##0.00""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	n=n+1" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strMember(n)=""Weekly Year-To-DatePrevYearSA""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strParentDimension(n)=""[Time].[Weekly].[All Time Weekly]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strStatement(n)=""[Time].[Weekly].[Date].&["" & str_PrevYear_Day & ""]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strSolveOrder(n)=""10""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strVisible(n)=0" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strFormat(n)=""### ### ### ##0.00""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	n=n+1" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strMember(n)=""Weekly Year-To-DatePrevYearA""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strParentDimension(n)=""[Time].[Weekly].[All Time Weekly]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strStatement(n)=""Aggregate( Except({ "" & _" & vbCrLf
	...
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strParentDimension(n)=""[Time].[Weekly].[All Time Weekly]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strStatement(n)=""IIF(Instr(MemberToStr([Measures].CurrentMember),""""Semiadd"""")>0, [Time].[Weekly].[Weekly Year-To-DatePrevYearSA], [Time].[Weekly].[Weekly Year-To-DatePrevYearA])""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strSolveOrder(n)=""10""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strFormat(n)=""### ### ### ##0.00""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	n=n+1		" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	" & vbCrLf
	...
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strMember(n)=""Weekly Year-To-PrevWeekSA""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strParentDimension(n)=""[Time].[Weekly].[All Time Weekly]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strStatement(n)=""[Time].[Weekly].[Week].&["" & str_PrevWeek_Week & ""]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strSolveOrder(n)=""10""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strVisible(n)=0" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strFormat(n)=""### ### ### ##0.00""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	n=n+1" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strMember(n)=""Weekly Year-To-PrevWeekA""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strParentDimension(n)=""[Time].[Weekly].[All Time Weekly]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strStatement(n)="" Aggregate(  "" & _" & vbCrLf
	...
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strParentDimension(n)=""[Time].[Weekly].[All Time Weekly]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strStatement(n)=""IIF(Instr(MemberToStr([Measures].CurrentMember),""""Semiadd"""")>0, [Time].[Weekly].[Weekly Year-To-PrevWeekSA], [Time].[Weekly].[Weekly Year-To-PrevWeekA])""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strSolveOrder(n)=""10""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strFormat(n)=""### ### ### ##0.00""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	n=n+1		" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	" & vbCrLf
	...
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strMember(n)=""Weekly Year-To-PrevWeekPrevYearSA""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strParentDimension(n)=""[Time].[Weekly].[All Time Weekly]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strStatement(n)=""[Time].[Weekly].[Week].&["" & str_PrevWeekPrevYear_Week & ""]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strSolveOrder(n)=""10""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strVisible(n)=0" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strFormat(n)=""### ### ### ##0.00""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	n=n+1" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strMember(n)=""Weekly Year-To-PrevWeekPrevYearA""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strParentDimension(n)=""[Time].[Weekly].[All Time Weekly]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strStatement(n)="" Aggregate(  "" & _" & vbCrLf
	...
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strParentDimension(n)=""[Time].[Weekly].[All Time Weekly]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strStatement(n)=""IIF(Instr(MemberToStr([Measures].CurrentMember),""""Semiadd"""")>0, [Time].[Weekly].[Weekly Year-To-PrevWeekPrevYearSA], [Time].[Weekly].[Weekly Year-To-PrevWeekPrevYearA])""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strSolveOrder(n)=""10""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strFormat(n)=""### ### ### ##0.00""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	n=n+1		" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	" & vbCrLf
	...
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	n=n+1" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strMember(n)=""Weekly PrevWeekSA""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strParentDimension(n)=""[Time].[Weekly].[All Time Weekly]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strStatement(n)=""[Time].[Weekly].[Week].&["" & str_PrevWeek_Week & ""]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strSolveOrder(n)=""10""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strVisible(n)=0" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strFormat(n)=""### ### ### ##0.00""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	n=n+1" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strMember(n)=""Weekly PrevWeekA""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strParentDimension(n)=""[Time].[Weekly].[All Time Weekly]""" & vbCrLf
	...
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strParentDimension(n)=""[Time].[Weekly].[All Time Weekly]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strStatement(n)=""IIF(Instr(MemberToStr([Measures].CurrentMember),""""Semiadd"""")>0, [Time].[Weekly].[Weekly PrevWeekSA], [Time].[Weekly].[Weekly PrevWeekA])""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strSolveOrder(n)=""10""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strFormat(n)=""### ### ### ##0.00""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	n=n+1		" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strMember(n)=""Weekly PrevWeekPrevYearSA""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strParentDimension(n)=""[Time].[Weekly].[All Time Weekly]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strStatement(n)=""[Time].[Weekly].[Week].&["" & str_PrevWeekPrevYear_Week & ""]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strSolveOrder(n)=""10""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strVisible(n)=0" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strFormat(n)=""### ### ### ##0.00""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	n=n+1" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strMember(n)=""Weekly PrevWeekPrevYearA""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strParentDimension(n)=""[Time].[Weekly].[All Time Weekly]""" & vbCrLf
	...
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strParentDimension(n)=""[Time].[Weekly].[All Time Weekly]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strStatement(n)=""IIF(Instr(MemberToStr([Measures].CurrentMember),""""Semiadd"""")>0, [Time].[Weekly].[Weekly PrevWeekPrevYearSA], [Time].[Weekly].[Weekly PrevWeekPrevYearA])""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strSolveOrder(n)=""10""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strFormat(n)=""### ### ### ##0.00""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	n=n+1		" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	" & vbCrLf
	...
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strStatement(n)="" ValidMeasure((  [Time].[Monthly].[Monthly Year-To-Date], [Time].[Weekly].[All Time Weekly] , [Time].[Salesperiod].[All Salesperiod])) """ & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strFormat(n)=""### ### ### ##0.00""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strSolveOrder(n)=""-10""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	n=n+1" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	" & vbCrLf
	...
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strParentDimension(n)=""[Time].[Salesperiod].[All Salesperiod]""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strStatement(n)="" ValidMeasure((  [Time].[Monthly].[Monthly Year-To-DatePrevYear], [Time].[Weekly].[All Time Weekly] , [Time].[Salesperiod].[All Salesperiod])) """ & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strFormat(n)=""### ### ### ##0.00""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strSolveOrder(n)=""-10""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	n=n+1" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	" & vbCrLf
	...
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strMember(n)=""Salesperiod Year-To-PrevSalesperiodSA""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strParentDimension(n)=""[Time].[Salesperiod].[All Salesperiod]""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strStatement(n)=""[Time].[Monthly].[Date].&["" & str_PrevSalesperiod_Day & ""]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strSolveOrder(n)=""10""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strVisible(n)=0" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strFormat(n)=""### ### ### ##0.00""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	n=n+1" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strMember(n)=""Salesperiod Year-To-PrevSalesperiodA""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strParentDimension(n)=""[Time].[Salesperiod].[All Salesperiod]""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strStatement(n)="" Aggregate( Except({ "" & _" & vbCrLf
	...
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strParentDimension(n)=""[Time].[Salesperiod].[All Salesperiod]""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strStatement(n)=""IIF(Instr(MemberToStr([Measures].CurrentMember),""""Semiadd"""")>0, [Time].[Salesperiod].[Salesperiod Year-To-PrevSalesperiodSA], [Time].[Salesperiod].[Salesperiod Year-To-PrevSalesperiodA])""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strSolveOrder(n)=""10""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strFormat(n)=""### ### ### ##0.00""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	n=n+1	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	" & vbCrLf
	...
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strMember(n)=""Salesperiod Year-To-PrevSalesperiodPrevYearSA""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strParentDimension(n)=""[Time].[Salesperiod].[All Salesperiod]""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strStatement(n)=""[Time].[Monthly].[Date].&["" & str_PrevSalesperiodPrevYear_Day & ""]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strSolveOrder(n)=""10""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strVisible(n)=0" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strFormat(n)=""### ### ### ##0.00""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	n=n+1" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strMember(n)=""Salesperiod Year-To-PrevSalesperiodPrevYearA""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strParentDimension(n)=""[Time].[Salesperiod].[All Salesperiod]""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strStatement(n)="" Aggregate( Except({ "" & _" & vbCrLf
	...
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strParentDimension(n)=""[Time].[Salesperiod].[All Salesperiod]""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strStatement(n)=""IIF(Instr(MemberToStr([Measures].CurrentMember),""""Semiadd"""")>0, [Time].[Salesperiod].[Salesperiod Year-To-PrevSalesperiodPrevYearSA], [Time].[Salesperiod].[Salesperiod Year-To-PrevSalesperiodPrevYearA])""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strSolveOrder(n)=""10""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strFormat(n)=""### ### ### ##0.00""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	n=n+1	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	" & vbCrLf
	...
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strMember(n)=""Salesperiod PrevSalesperiodSA""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strParentDimension(n)=""[Time].[Salesperiod].[All Salesperiod]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strStatement(n)=""[Time].[Salesperiod].[Salesperiod].&["" & str_PrevSalesperiod_Salesperiod & ""]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strSolveOrder(n)=""10""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strVisible(n)=0" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strFormat(n)=""### ### ### ##0.00""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	n=n+1" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strMember(n)=""Salesperiod PrevSalesperiodA""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strParentDimension(n)=""[Time].[Salesperiod].[All Salesperiod]""" & vbCrLf
	...
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strParentDimension(n)=""[Time].[Salesperiod].[All Salesperiod]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strStatement(n)=""IIF(Instr(MemberToStr([Measures].CurrentMember),""""Semiadd"""")>0, [Time].[Salesperiod].[Salesperiod PrevSalesperiodSA], [Time].[Salesperiod].[Salesperiod PrevSalesperiodA])""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strSolveOrder(n)=""10""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strFormat(n)=""### ### ### ##0.00""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	n=n+1" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	" & vbCrLf
	...
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strMember(n)=""Salesperiod PrevSalesperiodPrevYearSA""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strParentDimension(n)=""[Time].[Salesperiod].[All Salesperiod]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strStatement(n)=""[Time].[Salesperiod].[Salesperiod].&["" & str_PrevSalesperiodPrevYear_Salesperiod & ""]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strSolveOrder(n)=""10""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strVisible(n)=0" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strFormat(n)=""### ### ### ##0.00""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	n=n+1" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strMember(n)=""Salesperiod PrevSalesperiodPrevYearA""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strParentDimension(n)=""[Time].[Salesperiod].[All Salesperiod]""" & vbCrLf
	...
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strParentDimension(n)=""[Time].[Salesperiod].[All Salesperiod]""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strStatement(n)=""IIF(Instr(MemberToStr([Measures].CurrentMember),""""Semiadd"""")>0, [Time].[Salesperiod].[Salesperiod PrevSalesperiodPrevYearSA], [Time].[Salesperiod].[Salesperiod PrevSalesperiodPrevYearA])""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strSolveOrder(n)=""10""" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	strFormat(n)=""### ### ### ##0.00""	" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	n=n+1" & vbCrLf
	oCustomTask1.ActiveXScript = oCustomTask1.ActiveXScript & "	" & vbCrLf
...
Set oCustomTask2 = oTask.CustomTask
	...
	oCustomTask2.ActiveXScript = oCustomTask2.ActiveXScript & "'######################################################" & vbCrLf
	oCustomTask2.ActiveXScript = oCustomTask2.ActiveXScript & "	" & vbCrLf	
	oCustomTask2.ActiveXScript = oCustomTask2.ActiveXScript & "'--------- process shared dims starting with Src first (source for virtual dims)  --------------" & vbCrLf
	oCustomTask2.ActiveXScript = oCustomTask2.ActiveXScript & "For j = dsoDB.Dimensions.Count To 1 Step -1   " & vbCrLf
	oCustomTask2.ActiveXScript = oCustomTask2.ActiveXScript & "	If Left(dsoDB.Dimensions(j).Name , 3)=""Src"" then dsoDB.Dimensions(j).Process processFull" & vbCrLf
	oCustomTask2.ActiveXScript = oCustomTask2.ActiveXScript & "Next" & vbCrLf
	oCustomTask2.ActiveXScript = oCustomTask2.ActiveXScript & "	" & vbCrLf	
