<%@ Control Language="c#" AutoEventWireup="false" Codebehind="TableControl.ascx.cs" Inherits="FI.UI.Web.OlapReport.TableControl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" enableViewState="False"%>
