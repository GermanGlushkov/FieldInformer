...
namespace FI.UI.Web
{
	...
	public class PageBase : System.Web.UI.Page
	{
		...
		internal static int _CreateRootTabs(FI.UI.Web.Controls.Tabs.TabView tv, string UserName, bool UserLoggedIn, bool NavigationEnabled, RootTabsEnum ActiveTab)
		{
			int tabId=0;
			int activeTabId=0;
