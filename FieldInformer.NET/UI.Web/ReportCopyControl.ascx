<%@ Control Language="c#" AutoEventWireup="false" Codebehind="ReportCopyControl.ascx.cs" Inherits="FI.UI.Web.ReportCopyControl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
