<%@ Page language="c#" Codebehind="DistributionDetails.aspx.cs" AutoEventWireup="false" Inherits="FI.UI.Web.WebServices.DistributionDetails" %>
							...
							<TR>
								<TD class="tbl1_capt" vAlign="middle" align="left" height="0px">&nbsp;
									<asp:button id="BackButton" CommandName="Back" Runat="server" Text="Back" Width="75px" Height="22px"
										CssClass="tbl1_ctrl"></asp:button></TD>
							</TR>
							<TR>
