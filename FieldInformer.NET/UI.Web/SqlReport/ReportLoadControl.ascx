<%@ Control Language="c#" AutoEventWireup="false" Codebehind="ReportLoadControl.ascx.cs" Inherits="FI.UI.Web.SqlReport.ReportLoadControl" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
